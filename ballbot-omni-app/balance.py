...
if __name__ == "__main__":
    ...
    for t in SoftRealtimeLoop(dt=DT, report=True):
        ...
        # Tx = KP_THETA_X * theta_err_x + KD_THETA_X * d_theta_err_x + KI_THETA_X * i_theta_err_x #- bt_controller.Ly * 0.8
        # Ty = KP_THETA_Y * theta_err_y + KD_THETA_Y * d_theta_err_y + KI_THETA_Y * i_theta_err_y #+ bt_controller.Lx * 0.8 
