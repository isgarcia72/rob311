...
if __name__ == "__main__":
    ...
    for t in SoftRealtimeLoop(dt=DT, report=True):
        ...
        error_x = -(desired_theta_x - theta_x) - 0.02 # positive bias causes -y direction movement
        error_y = -(desired_theta_y - theta_y) - 0.001 # positive bias causes -x direction movement
        ...
        Tx = KP_THETA_X * error_x + KD_THETA_X * d_error_x
        Ty = KP_THETA_Y * error_y + KD_THETA_Y * d_error_y
        Tz = -rob311_bt_controller.tz_demo_1 * 0.1
